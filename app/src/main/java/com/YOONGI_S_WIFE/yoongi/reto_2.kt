...
fun main() {
    ...
    println("bienvenid@ a supermercados Noel, estamos de aniversario, por ello te daremos un descuento si tu uenta es mayor a 50.000 pesos")
    ...
    do {
        ...
        if (recibe_cajero >= valor_final_compra) {
            ...
            println("le hacen falta ${recibe_cajero - valor_final_compra}")

        } else {

            println("su cambio es: ${recibe_cajero -  valor_final_compra}")

        }

        println("vas a realizar otra venta?, si lo desea digite si, de lo contrario no")
        nueva_venta = readLine()!!.toString()
